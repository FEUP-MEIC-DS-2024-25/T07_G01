            ...
            <div className={`sidebar ${sidebarExpanded ? 'expanded' : ''}`} id="sidebar">
                <div className="expand-container">
                    <button className="toggle-btn" onClick={toggleSidebar}>
                        <img src={sidebarExpanded ? icons.left_arrow : icons.right_arrow} alt="Toggle Sidebar"
                             className="collapsed-icon"/>
                    </button>
                </div>
                <div className="new-chat-container">
                    <button className="toggle-btn">
                        <img src={sidebarExpanded ? icons.new_chat : icons.add_circle} alt="New Chat"
                             className={sidebarExpanded ? "new-chat-expanded" : "new-chat-collapsed"}/>
                    </button>
                </div>
                <div className="chat-history-container">
                    ...
                    {chats.map((chat) => (
                        <div key={chat.id} className="chat-history-item">
                            <a href={`/input_user_stories/${chat.id}`} className="chat-link">
                                <span className="chat-title">{chat.title}</span>
                            </a>
                            <div className="delete-chat-container">
                                <a href={`/delete_chat/${conversationId}/${chat.id}`}>
                                    <button className="toggle-btn">
                                        <img className="delete-chat" src={icons.trash} alt="Delete Chat"/>
                                    </button>
                                </a>
                            </div>
                        </div>
